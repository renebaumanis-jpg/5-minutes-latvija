...
[The signature recurring section. What the reader needs to know is COMING.
Three short beats:]

**Galvenais notikums:** [The one thing Latvia will likely be talking about next week. One prediction. One reason it matters.]

**Kas mainās:** [One concrete change happening next week — policy, price, deadline, event, decision — that affects daily life or business.]

**Ko vērot:** [One trend, story, or signal worth tracking that hasn't fully landed yet.]
...
1. Is there ONE clear thesis for the week, expressed in ŠONEDĒĻ?
2. Did I MERGE related stories instead of fragmenting them?
3. Does every major story have a "what this means for me" angle?
4. Are there at least 2-3 forwardable observation lines?
5. Did I cut institutional language by 40-50% from instinct?
6. Is ĀTRIE JAUNUMI sharp, not a junk drawer?
7. Does NĀKAMĀ NEDĒĻA give the reader something to anticipate?
8. Would someone who reads this feel BEHIND without it?
9. Is there ZERO AI/process leakage at the top?
10. Does it read like a human editor wrote it, not an AI?
